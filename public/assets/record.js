...
# --- IMPORTANT FIX ---
# Do NOT click any header section here.
# The UIAutomation block above already collapses Response Headers and
# scrolls Request Headers into view. The old OCR block incorrectly
# searched for and clicked "Response headers", then pressed END, which
# moved the view away from the Request Headers values.
#
# Leave the current Request Headers view untouched and capture it.
Start-Sleep -Milliseconds 200
